...
Data mencakup perusahaan FMCG fiktif dengan **5 pabrik**, **505 equipment**, **3.009 work order**, **1.824 aktivitas perawatan**, **63 kegagalan**, dan **54 dokumen**, dalam rentang **3 tahun**.
...
Graph disimpan sebagai daftar edge terpadu (**6.471 node, 10.094 edge, 13 label node, 16 jenis edge**) dan ditelusuri dengan recursive CTE — jalan penuh di on-demand, tanpa reservation.
